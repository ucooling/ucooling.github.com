---
layout: post
title: "Photo-Sphere-Viewer初体验"
date: 2017-03-29 10:16:50 +0800
comments: true
categories: 
---
###为什么会有这篇博文
这一篇是接上一篇Aframe初体验的另一篇文章，用另一种方式来实现一个全景图片的展示.

###什么是Photo Sphere Viewer
photo sphere viewer也是一款基于Three.js的360度全景图预览的js插件。可以360图旋转查看全景图，也可以上下180度查看图片。它同时也支持WebVR

###实现
* 基本结构，引入photo-sphere-viewer
...
* 初始化PhotoSphereViewer

```
PSV = new PhotoSphereViewer({
        panorama: './assets/imgs/quanjing1.jpg',
        container: "container",
        autoload: true,
        time_anim: 500,
        anim_speed: "0.3rpm",
        zoome_level: 100,  //缩放级别
        navbar: false,
        size: {
            width: winWidth,
            height: winHeight+"px"
...
#总结
综上，photo photo viewer使用非常简单，基本就是一些配置，如果要对DOM进行一些控制基本上都是借助于JS的DOM操作。
